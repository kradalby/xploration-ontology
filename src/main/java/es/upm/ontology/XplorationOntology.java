...
public class XplorationOntology extends jade.content.onto.Ontology  {
  ...
  public static Ontology getInstance() {
   ...
   // VOCABULARY
    public static final String NOTIFYWORLD_ROVERINITIALLOCATIONS="roverInitialLocations";
    public static final String NOTIFYWORLD="NotifyWorld";
    ...
    public static final String MOVEINFORMATION_AID="aid";
    ...
    public static final String PROTOCOL_NOTIFY_WORLD="PROTOCOL_NOTIFY_WORLD";
    ...
    public static final String ROVERINITIALLOCATION_AID="aid";
    public static final String ROVERINITIALLOCATION_LOCATION="location";
    public static final String ROVERINITIALLOCATION="RoverInitialLocation";
  ...
  */
  private XplorationOntology(){ 
    ...
    ConceptSchema roverInitialLocationSchema = new ConceptSchema(ROVERINITIALLOCATION);
    add(roverInitialLocationSchema, es.upm.ontology.RoverInitialLocation.class);
    ...
    ConceptSchema protocoL_notifY_worldSchema = new ConceptSchema(PROTOCOL_NOTIFY_WORLD);
    add(protocoL_notifY_worldSchema, es.upm.ontology.PROTOCOL_NOTIFY_WORLD.class);
    ...
    AgentActionSchema notifyWorldSchema = new AgentActionSchema(NOTIFYWORLD);
    add(notifyWorldSchema, es.upm.ontology.NotifyWorld.class);
    ...
    roverInitialLocationSchema.add(ROVERINITIALLOCATION_LOCATION, locationSchema, ObjectSchema.OPTIONAL);
    roverInitialLocationSchema.add(ROVERINITIALLOCATION_AID, (ConceptSchema)getSchema(BasicOntology.AID), ObjectSchema.OPTIONAL);
    ...
    moveInformationSchema.add(MOVEINFORMATION_AID, (ConceptSchema)getSchema(BasicOntology.AID), ObjectSchema.OPTIONAL);
    ...
    notifyWorldSchema.add(NOTIFYWORLD_ROVERINITIALLOCATIONS, new ConceptSchema("Concept"), 0, ObjectSchema.UNLIMITED);
    ...
    protocoL_notifY_worldSchema.addSuperSchema(protocolSchema);
