...
public class XplorationOntology extends jade.content.onto.Ontology  {
  ...
  */
  private XplorationOntology(){ 
    ...
    registerAgentsSchema.add(REGISTERAGENTS_ROVER, roverSchema, ObjectSchema.OPTIONAL);
    registerAgentsSchema.add(REGISTERAGENTS_CAPSULE, capsuleSchema, ObjectSchema.OPTIONAL);
